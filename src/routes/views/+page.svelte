<div class="mt-12 container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 px-4">
	...
	<a class="border rounded text-center py-4 px-4 block" href="/views/lifecounter"> Life Counter </a>
	<a class="border rounded text-center py-4 px-4 block" href="/views/cardreader"> Card Reader </a>
